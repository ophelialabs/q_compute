...
<nav>
        <ul>
            ...
            <li><a href="#deployment-tools">Deployment</a></li>
...
<section id="programming-languages" class="section">
        ...
        <div class="grid-container">
            <div class="card">
                <h3>Q# (Quantum Sharp)</h3>
                <p>Microsoft's quantum programming language specifically designed for quantum algorithm development and integration with classical code.</p>
            </div>
            <div class="card">
                <h3>Python</h3>
                <p>Dominant language for data science, machine learning, and quantum algorithm prototyping with extensive libraries.</p>
            </div>
            <div class="card">
                <h3>Java</h3>
                <p>Enterprise-grade language for scalable backend systems, microservices, and complex application architectures.</p>
            </div>
            <div class="card">
                <h3>C#</h3>
                <p>.NET ecosystem integration for Windows Server, Azure cloud services, and enterprise solutions.</p>
            </div>
            <div class="card">
                <h3>Rust</h3>
                <p>Systems programming language for high-performance, memory-safe applications and embedded systems.</p>
            </div>
            <div class="card">
                <h3>C++</h3>
                <p>Performance-critical applications, scientific computing, and low-level system optimization.</p>
            </div>
        </div>
    </section>
...
<h3>Quantum Computing</h3>
        <ul>
            ...
            <li><strong>Silq:</strong> High-level quantum language compiler</li>
            <li><strong>PyQuil (Rigetti):</strong> Python library for quantum program development</li>
...
<h3>Backend Frameworks</h3>
        <ul>
            ...
            <li><strong>.NET Aspire:</strong> Cloud-native .NET application development</li>
...
<h3>CI/CD</h3>
        <ul>
            ...
            <li><strong>GitHub Actions:</strong> CI/CD in GitHub</li>
            <li><strong>CircleCI:</strong> Cloud-native CI/CD platform</li>
            <li><strong>ArgoCD:</strong> Declarative GitOps for Kubernetes</li>
        </ul>
    </section>
...
<h3>Metrics & Monitoring</h3>
        <ul>
            ...
            <li><strong>DataDog:</strong> Cloud monitoring and analytics</li>
...
<h3>Logging</h3>
        <ul>
            ...
            <li><strong>Loki:</strong> Log aggregation system for Kubernetes</li>
...
<h3>Tracing</h3>
        <ul>
            ...
            <li><strong>Tempo:</strong> Kubernetes-native tracing backend</li>
        </ul>
    </section>
