...
- [Getting Started-Julia](/basic_syntax/)
| [Fastrack-Julia](https://juliadocs.github.io/Julia-Cheat-Sheet/)
| [Sample Homework](/q_compute/homework/hw1) 

---

- [MATLAB-Julia-Python](https://cheatsheets.quantecon.org/) by [QuantEcon group](https://quantecon.org)
| [Plots.jl cheatsheet](https://github.com/sswatson/cheatsheets/blob/master/plotsjl-cheatsheet.pdf)
| [Math Cheatsheet](/q_compute/resources/mat)
