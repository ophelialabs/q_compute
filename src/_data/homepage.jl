    ...
    "references" => [
        ...
        Dict("name" => "Nuget F#",
         ...
         Dict("name" => "Quantum Providers",
           ...
           Dict("name" => "Quantum Courses",
              "url" => "resources/courses",
              "description" => "Browse quantum course offerings in a dropdown list.",
              "img" => "https://user-images.githubusercontent.com/6933510/168320384-9c8b1e5c-7a3d-4f2e-9b1c-8a0e5a7c6b9c.png",
              "category" => "Quantum Courses",
              "dropdown" => true,
              "items" => [
                  Dict("name" => "Intro to Quantum Computing", "url" => "resources/courses/intro"),
                  Dict("name" => "Quantum Algorithms", "url" => "resources/courses/algorithms"),
                  Dict("name" => "Quantum Machine Learning", "url" => "resources/courses/ml")
              ]
         )
    ]
)
